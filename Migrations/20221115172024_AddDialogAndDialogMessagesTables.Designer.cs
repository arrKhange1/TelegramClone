...
namespace TelegramClone.Migrations
{
    ...
    [Migration("20221115172024_AddDialogAndDialogMessagesTables")]
    partial class AddDialogAndDialogMessagesTables
    {
            ...
            modelBuilder.Entity("TelegramClone.Models.ChatCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ChatCategoryId = new Guid("e3a5ecde-5efb-4f9a-844b-51774a896548"),
                            ChatCategoryName = "private"
                        },
                        new
                        {
                            ChatCategoryId = new Guid("ac100696-77a3-4404-8a76-e565309cbb05"),
            ...
            modelBuilder.Entity("TelegramClone.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("62088a5c-45a3-4cbd-961e-fb171c87327f"),
                            RoleName = "admin"
                        },
                        new
                        {
                            RoleId = new Guid("4b591661-5e61-4337-b38a-e0af5cbf996e"),
                            RoleName = "user"
                        });
                });
            ...
            modelBuilder.Entity("TelegramClone.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("93d7efab-74c3-444f-bf88-1e4a5237fea1"),
