...
namespace TelegramClone.Migrations
{
    ...
    [Migration("20220917095203_AddUserPhotoToUserTable")]
    partial class AddUserPhotoToUserTable
    {
            ...
            modelBuilder.Entity("TelegramClone.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("248cf7fc-ca68-4ffa-93c0-82ea0f451157"),
                            RoleName = "admin"
                        },
                        new
                        {
                            RoleId = new Guid("671cba6a-0dc8-48dc-9b58-42e7fe089f61"),
                            RoleName = "user"
                        });
                });
            ...
            modelBuilder.Entity("TelegramClone.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("bdf63c85-e9a1-497d-bc9c-bbee38840ab3"),
